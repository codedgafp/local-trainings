...
class recyclebin_renderer extends \plugin_renderer_base {
    ...
    private function create_recyclebin_table($items, $hassubentity) {
        ...
        foreach ($items as $item) {
            ...
            // Build restore link.
            $restoreurl = new \moodle_url(new \moodle_url('/local/trainings/pages/recyclebin_trainings.php', [
            ...
            // Build delete link.
            $deleteurl = new \moodle_url(new \moodle_url('/local/trainings/pages/recyclebin_trainings.php', [
                'entityid' => $item->entityid,
            ]), [
                'contextid' => $item->contextid,
                'itemid' => $item->id,
    ...
    /**
     * Check if in training list, sub entity exist.
     *
     * @param object[] $items
     * @return bool
     */
