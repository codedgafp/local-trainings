...
class trainings_renderer extends \plugin_renderer_base implements \format_edadmin\output\edadmin_renderer {
    ...
    public function display($course, $section) {
        ...
        if (has_capability('tool/recyclebin:viewitems', $trainingcategorycontext)) {
            $params->recyclebinlink = new \moodle_url('/local/trainings/pages/recyclebin_trainings.php', [
        ...
        $this->page->requires->js_call_amd($js, 'init', [$params]);
        ...
        if (has_capability('local/mentor_core:sharetrainings', $context)) {
            ...
            $entities = entity_api::get_all_entities(true, [], true, null, $includehidden);
        ...
        if ($params->hassubentities) {
            ...
            if (count($params->subentities) === 1) {
                $params->subentity = current($params->subentities)->id;
            }
        }
        ...
        $params->hassubentitiestocreatesession = count($params->subentities) > 1;
